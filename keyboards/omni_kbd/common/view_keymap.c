...
const char* get_display_string_jis(uint16_t keycode) {
    ...
    if (base == MS_BTN1) return "CL";
    if (base == MS_BTN2) return "CR";
    if (base == MS_BTN3) return "CS";
...
display_label_t get_display_label(uint16_t keycode) {
    ...
    switch (keycode) {
        case MS_BTN1:   dl.label = lbl_cl; dl.is_special = true; break;
        case MS_BTN2:   dl.label = lbl_cr; dl.is_special = true; break;
        case MS_BTN3:   dl.label = lbl_cs; dl.is_special = true; break;
        case KC_LSFT:
