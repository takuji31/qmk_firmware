...
__attribute__((weak)) const char *get_os_name_user(void) {
    return NULL;
}
...
void oled_write_layer_state(void) {
    ...
    const char *os_name = get_os_name_user();
    oled_write(os_name != NULL ? os_name : "-------", false);
    oled_write_P(PSTR(" "), false);
    ...
    oled_write_P(PSTR(" "), false);
    const char *layer_name = get_layer_name_user(highest_layer);
    oled_write(layer_name != NULL ? layer_name : "        ", false);
    oled_write_P(PSTR("   "), false);
